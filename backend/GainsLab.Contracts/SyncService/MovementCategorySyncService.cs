...
public class MovementCategorySyncService : ISyncService<MovementCategorySyncDto>
{
        ...
        CancellationToken ct)
    {
        ...
        {
            _db.MovementCategoryRelations.Add(new MovementCategoryRelationDTO
            {
    ...
    public async Task<PushResult> PushAsync(IEnumerable<MovementCategorySyncDto> items, CancellationToken ct)
    {
        ...
        var payloads = new List<(MovementCategoryDTO Entity, Guid? ParentGuid, IReadOnlyList<eMovementCategories> BaseCategories)>();
        ...
        try
        {
            await executionStrategy.ExecuteAsync(async () =>
            {
                ...
                var accepted = 0;
                var failed = 0;
                var pendingRelations = new List<(MovementCategoryDTO Entity, Guid? ParentGuid, IReadOnlyList<eMovementCategories> BaseCategories)>();
